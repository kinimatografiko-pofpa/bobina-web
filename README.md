...
The website is built on [Astro](https://astro.build/) and uses [wordpress.com](https://wordpress.com) as a back-end to fetch articles. For styling it uses [Tailwind](https://tailwindcss.com/) and [GlideJS](https://glidejs.com/) for the carousel.
